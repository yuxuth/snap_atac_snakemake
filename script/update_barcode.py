...
def find_barcode_info(fragmentsfilename,barcodes,barcode_map_file,barcode_log_file,OUTPUT_FILENAME):
    ...
    f_out_barcode_log.write("0   mismatch: %d fragments from %d barcodes \n" % (frag_info[0],barcode_info[0]))
    f_out_barcode_log.write("1   mismatch: %d fragments from %d barcodes \n" % (frag_info[1],barcode_info[1]))
    f_out_barcode_log.write("2+  mismatch: %d fragments from %d barcodes \n" % (frag_info[2],barcode_info[2]))
    f_out_barcode_log.write("Match with 2: %d fragments from %d barcodes \n" % (frag_info[3],barcode_info[3]))
